...
def calcBearing(pointA, pointB):
	'''
	In this function, north is zero.
	Output varies between 180 (for south heading with -right hand rule)
	to -180 (for south heading with right hand rule)

	For testing:
	coord1 = {'lat':42.047024, 'lon':-93.643570} # coord1 to coord2 : east to west
	coord2 = {'lat':42.047028, 'lon':-93.644029}

	coord3 = {'lat':42.047167, 'lon':-93.644009}
	coord4 = {'lat':42.047210, 'lon':-93.644011} # coord3 to coord4 : south to north

	coord5 = {'lat':42.046954, 'lon':-93.644759}
	coord6 = {'lat':42.047070, 'lon':-93.645075} # coord5 to coord6 : south-east to north-west
	'''
